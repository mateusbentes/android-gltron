...
namespace GltronMonoGame.Video
{
    public class WorldGraphics
    {
        ...
        public void DrawWalls(Segment[] walls)
        {
        ...
        public void DrawBike(BasicEffect fx, Player p)
        {
            // Placeholder: until model loader exists, skip
        }

        public void DrawExplosion(BasicEffect fx, Player p)
        {
